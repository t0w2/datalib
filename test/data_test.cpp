...
{
    // Tony updated a comment from prilepski-patch-1, the 5th time.
...
{
    // Tony updated a comment from prilepski-patch-2, the 5th time.
    own_array<int> myarray;
...
{
    // Tony updated comment from prilepski-patch-3, the 5th time.
    own_array<int> myarray;
